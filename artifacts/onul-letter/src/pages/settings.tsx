...
import { Bell, Moon, Info, Trash2, LogOut, Pencil, Check, X, ChevronDown, Loader2 } from 'lucide-react';
      ...
      >
        ...
        <div className="px-5 pb-5">
          <button
            ...
            className="w-full py-3 rounded-2xl font-bold text-sm flex items-center justify-center gap-2.5 bg-foreground text-background hover:opacity-90 active:scale-[0.98] transition-all shadow-sm disabled:opacity-50"
          >
            {isLoggingIn ? (
            ...
            {isLoggingIn ? '서버 연결 중...' : 'Google로 로그인하기'}
          </button>
        </div>
      </motion.div>
    );
